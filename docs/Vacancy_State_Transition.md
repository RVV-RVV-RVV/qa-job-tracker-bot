flowchart TD
    ...
    subgraph Cron [Cron Manager, AppSheet & Авто-Двірник]
        C1((AppSheet)) -.-> |God Mode: Пряма зміна БД| C1_A{Статус = Відмова?}
        C1_A -- Ні (Інший статус) --> B8
        C1_A -- Так --> C1_B[Авто-Двірник: Форматування] --> C1_C[Авто-архів: Ручна Відмова]:::archive
